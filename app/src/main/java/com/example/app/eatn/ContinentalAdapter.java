...
public class ContinentalAdapter extends ArrayAdapter<ContinentalClass> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ContinentalClass currentfastfood = getItem(position);
        ...
        cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Integer.parseInt(currentfastfood.getItemquantity()) != 0) { //if quan < 0 or equals to 0
                    if (pos == 0) {
                        boolean isinserted = mydb.Add_to_Cart("Salsa",currentfastfood.getItemquantity(),String.valueOf(650*Integer.parseInt(currentfastfood.getItemquantity())));
                        if (isinserted)
                        {
                            int price = 1; //price * quantity = total price
                            order_details[i] = "Id " + counter + "Salsa Price Rs " + 650 * Integer.parseInt(currentfastfood.getItemquantity()) + " ";
                    ...
                    if (pos == 1) {
                        boolean isinserted =  mydb.Add_to_Cart("Arabic Pizza",currentfastfood.getItemquantity(),String.valueOf(1150*Integer.parseInt(currentfastfood.getItemquantity())));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Arabic Pizza Rs " + 1150 * Integer.parseInt(currentfastfood.getItemquantity())  + " ";
                            counter++;
                            i++;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 2) {
                        boolean isinserted = mydb.Add_to_Cart("Macaroni",currentfastfood.getItemquantity(),String.valueOf(250*Integer.parseInt(currentfastfood.getItemquantity())));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id : " + counter + " Macaroni Price Rs " + 250 * Integer.parseInt(currentfastfood.getItemquantity()) + " ";
                            counter++;
                            i++;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 3) {
                        ...
                        boolean isinserted = mydb.Add_to_Cart("Pan Burger",currentfastfood.getItemquantity(),String.valueOf(190*Integer.parseInt(currentfastfood.getItemquantity() )));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Pan Burger Rs " + 190 * Integer.parseInt(currentfastfood.getItemquantity() )+ " ";
                            counter++;
                            i++;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
